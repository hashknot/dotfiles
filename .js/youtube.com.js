...
(function () {
	...
	var BUTTON_TEXT={'ar':'ØªÙ†Ø²ÙŠÙ„','cs':'StÃ¡hnout','de':'Herunterladen','en':'Download','es':'Descargar','fr':'TÃ©lÃ©charger','it':'Scarica','ja':'ãƒ€ã‚¦ãƒ³ãƒ­ãƒ¼ãƒ‰','pl':'Pobierz','pt':'Baixar','ro':'DescÄƒrcaÈ›i','ru':'Ð¡ÐºÐ°Ñ‡Ð°Ñ‚ÑŒ','zh':'ä¸‹è½½'};
	var BUTTON_TOOLTIP={'ar':'ØªÙ†Ø²ÙŠÙ„ Ù‡Ø°Ø§ Ø§Ù„ÙÙŠØ¯ÙŠÙˆ','cs':'StÃ¡hnout toto video','de':'Dieses Video herunterladen','en':'Download this video','es':'Descargar este vÃ­deo','fr':'TÃ©lÃ©charger cette vidÃ©o','it':'Scarica questo video','ja':'ã“ã®ãƒ“ãƒ‡ã‚ªã‚’ãƒ€ã‚¦ãƒ³ãƒ­ãƒ¼ãƒ‰ã™ã‚‹','pl':'Pobierz plik wideo','pt':'Baixar este vÃ­deo','ro':'DescÄƒrcaÈ›i acest videoclip','ru':'Ð¡ÐºÐ°Ñ‡Ð°Ñ‚ÑŒ ÑÑ‚Ð¾ Ð²Ð¸Ð´ÐµÐ¾','zh':'ä¸‹è½½æ­¤è§†é¢‘'};
