...
" Vundle
    ...
    call vundle#begin()
        ...
        Plugin 'ctrlpvim/ctrlp.vim'                 " Intelligent file/buffer auto-completion
        ...
        Plugin 'preservim/nerdtree'                " File browser pane
        ...
        Plugin 'fatih/vim-go'                       " Golang completion
...
" Appearance
    ...
    " Statusline
        ...
        set statusline+=\ \%-.100F  " full file path, truncated at 60 chars, left justified
...
" Automate
    ...
    " Filetype specific
        ...
        au BufNewFile,BufRead *.go set noexpandtab | set nolist
